...
const FloralTileProduct = () => {
  ...
  return (
    <div className="product-container">
      ...
      <iframe style={{position:'absolute',height:'100%',width:'50%',border:'none'}} title="Dec Flor Azul Antic Blanco" frameborder="0" allowfullscreen mozallowfullscreen="true" webkitallowfullscreen="true" allow="autoplay; fullscreen; xr-spatial-tracking" xr-spatial-tracking execution-while-out-of-viewport execution-while-not-rendered web-share src="https://sketchfab.com/models/104fe4ce0b1e4a0e9c5425b91aa56096/embed"></iframe>
    </div>
      </div>
...
export default FloralTileProduct;
