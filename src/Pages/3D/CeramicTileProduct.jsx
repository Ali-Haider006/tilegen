...
const CeramicTileProduct = () => {
  ...
  return (
    <div className="product-container">
      ...
      <iframe style={{position:'absolute',height:'100%',width:'50%',border:'none'}} title=" " frameborder="0" allowfullscreen mozallowfullscreen="true" webkitallowfullscreen="true" allow="autoplay; fullscreen; xr-spatial-tracking" xr-spatial-tracking execution-while-out-of-viewport execution-while-not-rendered web-share src="https://sketchfab.com/models/c6dec21a6b5649bb9b097b6d20b95a7d/embed"></iframe>
    </div>
      </div>
